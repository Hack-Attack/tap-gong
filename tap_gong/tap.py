...
class TapGong(Tap):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        This is an extended validation to validate start_date and
        end_date provided through config file. Meltano SDK currently
        doesn't have a way to compare or validate values in config
        file parameters other than validating data type and optional
        or required filed. This solution was suggested by a Meltano
        expert.
        """
